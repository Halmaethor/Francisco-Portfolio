...
function gotoSection(){var a=$(this).attr("href");scrollTween.pause().invalidate();scrollTween.vars.scrollTo=$(a).offset().top;console.log(scrollTween.vars);scrollTween.restart();return!1}
